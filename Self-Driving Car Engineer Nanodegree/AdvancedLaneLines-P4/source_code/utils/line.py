...
class Line:
    ...
    def is_current_fit_parallel(self, other_line, threshold=(0, 0)):
        """
        check if two lines are parallel by comparing their first two coefficients.
    ...
    def get_current_fit_distance(self, other_line):
        """
        get the distance between the current fit polynomials of two lines
        :param other_line:
        :return:
        """
    ...
    def get_best_fit_distance(self, other_line):
        """
        get the distance between the best fit polynomials of two lines
        :param other_line:
        :return:
        """
