...
"""
Srikanth Pagadala's Note: 
I ran into lot of performance issues with standard turtle library. 
So I ended up patching it. This is my version of turtle. Next time please remind me to try pygame.
In the end, I'm very happy with how turtle based UI has turned out. I think I managed 
to squeeze a good performance out of it.
